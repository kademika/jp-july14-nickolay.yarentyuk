...
//	private int number;
	...
	public Registration(/*Store store*/) {
...
//		number = 0;
	...
	public void newTranzaction(Customer customer, Device device) {
...
//			nNew = t.length;
//		} else {
//			for (nNew = 0; nNew < transactions.length; nNew++) {
//				if (transactions[nNew] == null) {
//					break;
//				}
//			}
//		}
//
//		transactions[nNew] = new Transaction(number, customer, device);
//
//		result.addTotal(1);
//		result.addCost(device.getPrice());
		...
		if ((transactions.length - 10) < deviceCounter) {
			...
			transactions[deviceCounter++] = new Transaction(deviceCounter, customer, device);
		}
		result.addTotal(1);
		result.addCost(device.getPrice());
	}
