...
public class Demo {
	...
	public Demo() {
		...
		facty.addObserver(s1);	// subscribed to Facty
		
		chip.addObserver(s1);	// subscribed to Chip
		
		theSubscriber s2 = new theSubscriber("Petr", "Petrov");	// Second subscriber
		facty.addObserver(s2);	// subscribed to Facty
		...
		facty.deleteObserver(s1);	// First subscriber canceled for subscribing Facty 
