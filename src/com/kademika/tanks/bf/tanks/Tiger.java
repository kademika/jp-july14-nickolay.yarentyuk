...
//		setImages();
	...
	private void setImages() {
		images = new Image[4];
		try {
			images[0] = ImageIO.read(new File("BT7 Up.jpg").getAbsoluteFile());
			images[1] = ImageIO.read(new File("BT7 Down.jpg").getAbsoluteFile());
			images[2] = ImageIO.read(new File("BT7 Left.jpg").getAbsoluteFile());
			images[3] = ImageIO.read(new File("BT7 Right.jpg").getAbsoluteFile());
		} catch (IOException e) {
